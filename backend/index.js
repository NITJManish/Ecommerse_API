...
mongoose.connect("mongodb+srv://kumarmanish150799:DHNSiiJWg9j6i6MZ@cluster0.osgiteu.mongodb.net/ecommerse-data?retryWrites=true&w=majority&appName=Cluster0");
...
//create endpoint for newcolection data
...
app.get("/popularinwomen",async (req,res)=>{
    let products=await Product({category:"women"});
    let popular_in_women=products.toString().slice(0,4);
